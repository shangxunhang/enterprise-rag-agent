...
from bootstrap.rag_factory import RAGToolFactory
...
class SupervisorFactory:
    def __init__(
        ...
        *,
        ...
        rag_factory: RAGToolFactory | None = None,
        ...
        self.rag_factory = rag_factory or RAGToolFactory()
    ...
    def build(
        ...
        *,
        ...
        tool_registry, rag_tool_name = self.rag_factory.build_registry(options)
        ...
        agents.register(
            SchemeWriterAgent(
                ...
                rag_retrieval_mode=options.retrieval_strategy,
